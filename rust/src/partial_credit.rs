...
pub fn trim_left(reference: &[u8], rv: &mut RefVar, ref_padding: bool) {
...
pub fn trim_right(reference: &[u8], rv: &mut RefVar, ref_padding: bool) {
...
pub fn left_shift(reference: &[u8], rv: &mut RefVar, mut pos_min: usize, ref_padding: bool) {
    if pos_min == 0 {
        pos_min = 1;
    }
