...
pub(crate) fn merge_two_sample_records(
...
fn merge_coordinate_group(
    ...
    for class in [
        ...
        while !truth_ids.is_empty() || !query_ids.is_empty() {
            ...
            super::compatibility::begin_allele_count_table(
                super::compatibility::AlleleCountArrayPolicy::LegacyReuse,
                &mut allele_counts,
            );
                ...
                .chain(query_ids.iter().map(|id| &query[*id]))
            {
                for key in allele_keys(record) {
                    ...
                    super::compatibility::record_allele_count(
                        &mut allele_counts,
                        slot,
                        first_record,
                    );
...
pub(crate) fn annotate_merged_records(
...
impl RefVar {
    pub(crate) fn legacy_key(&self) -> String {
