...
pub fn realign_ref_var(ref_start: usize, ref_allele: &[u8], alt_allele: &[u8]) -> Vec<RefVar> {
...
pub fn to_primitives(ref_start: usize, ref_allele: &[u8], alt_allele: &[u8]) -> Vec<RefVar> {
    let mut out = Vec::new();
